...
from .views import EstoqueCreateView, EstoqueListView,ListagemCompradoresView,DetalheCompradoresListView
...
urlpatterns = [
    ...
    path('detalhe_compradores_listar/', DetalheCompradoresListView.as_view(), name='distribuidor_detail'),
]